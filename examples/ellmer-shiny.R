## Original example in async_repo: https://github.com/hypebright/async_shiny/blob/main/extendedTask/extendedtask_ellmer.R
...
system_prompt_file <- here::here("examples", "baby-activities-system-prompt.md")
